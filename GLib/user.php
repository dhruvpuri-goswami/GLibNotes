...
<body class="w3-theme-l5">
    ...
    <div class="w3-top">
        <div class="w3-bar w3-teal w3-left-align w3-large">
            <a class="w3-bar-item w3-button w3-hide-medium w3-hide-large w3-right w3-padding-large w3-hover-white w3-large w3-teal"
                href="javascript:void(0);" onclick="openNav()"><i class="fa fa-bars"></i></a>
            <a href="#" class="w3-bar-item w3-button w3-padding-large w3-flat-turquoise"><i
                    class="fa fa-book w3-margin-right"></i>GLib Notes</a>
            <div class="w3-center">
            ...
            <div class="w3-col m7">
                ...
                <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                    ...
                    <button type="button" class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-thumbs-up"></i>
                        Like</button>
                    <button type="button" class="w3-button w3-teal w3-margin-bottom"><i class="fa fa-comment"></i>
                        Comment</button>
                </div>
